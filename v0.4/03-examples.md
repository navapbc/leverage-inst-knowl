...
| (DL output) Retrieval signals | Confluence page labels, tags, metadata | Semantic embeddings and metadata in vector DB |
...
* DL output
    ...
    * Retrieval signals: Confluence page labels, tags, metadata (e.g., each space's [Update History](https://navasage.atlassian.net/wiki/spaces/PIVAAIS/pages/3078684730/Update+History))
