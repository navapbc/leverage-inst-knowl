...
- **B. Edited-since aware** — **staleness gating** (downgrade if the record's content-state marker no longer matches the one stored at confirmation) and recency decay.
